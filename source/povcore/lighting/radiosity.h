...
#include "povcore/lighting/photons.h" // TODO FIXME - make PhotonGatherer class visible only as a pointer
#include "povcore/material/media.h"   // TODO FIXME - make MediaFunction class visible only as a pointer
#include "povcore/math/randcosweighted.h"
#include "povcore/render/trace.h"     // TODO FIXME - make Trace class visible only as a pointer
#include "povcore/support/octree.h"   // TODO FIXME - this should only be included in radiosity.cpp
#include "povcore/support/statistics.h"
